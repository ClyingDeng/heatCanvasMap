...
var Canvas2dRenderer = (function Canvas2dRendererClosure() {
  ...
  function Canvas2dRenderer(config) {
    ...
    this._palette = _getColorPalette(config); // 彩带转成像素
    this._templates = {};
  ...
  Canvas2dRenderer.prototype = {
    ...
    _drawAlpha: function(data) {
      ...
      while(dataLen--) {
        ...
        var tpl;
        if (!this._templates[radius]) { //{48:canvas}
        ...
        // => [0, 1]
        var templateAlpha = (value-min)/(max-min); // 叠加的权重
...
var Heatmap = (function HeatmapClosure() {
  ...
  function Heatmap() {
    ...
    this._coordinator = new Coordinator(); // 发布订阅机制
    if (config['plugin']) {
